...
UNIDADES = (
    ("sti", "HML-STI", "Superintendência de Tecnologia da Informação"),
    ("prad", "HML-PRAD", "Pró-Reitoria de Administração"),
    ("preuni", "HML-PREUNI", "Prefeitura Universitária"),
    ("biblioteca", "HML-BC", "Biblioteca Central"),
    ("cmpp", "HML-CMPP", "Campus Ministro Petrônio Portella"),
    ("cce", "HML-CCE", "Centro de Ciências da Educação"),
    ("ccn", "HML-CCN", "Centro de Ciências da Natureza"),
    ("ct", "HML-CT", "Centro de Tecnologia"),
    ("parnaiba", "HML-CPAR", "Campus de Parnaíba"),
    ("picos", "HML-CPIC", "Campus de Picos"),
    ("floriano", "HML-CFLO", "Campus de Floriano"),
    ("computacao", "HML-CCOMP", "Coordenação do Curso de Computação"),
    ("enfermagem", "HML-CENF", "Coordenação de Enfermagem"),
    ("administracao", "HML-CADM", "Coordenação de Administração"),
    ("matematica", "HML-DMAT", "Departamento de Matemática"),
    ("fisica", "HML-DFIS", "Departamento de Física"),
    ("letras", "HML-DLET", "Departamento de Letras"),
)
